package edu.msu.ettemaet.cloudhatter;
...
public class Cloud {
    ...
    private static final String USER = "ettemaet";
    private static final String PASSWORD = "eightdig";
    //private static final String CATALOG_URL = "https://facweb.cse.msu.edu/cbowen/cse476x/hatter-cat.php";
    private static final String CATALOG_URL = "http://webdev.cse.msu.edu/~ettemaet/cse476/step6/hatter-cat.php";
    //private static final String SAVE_URL = "https://facweb.cse.msu.edu/cbowen/cse476x/hatter-save.php";
    private static final String SAVE_URL = "http://webdev.cse.msu.edu/~ettemaet/cse476/step6/hatter-save.php";
    //private static final String DELETE_URL = "https://facweb.cse.msu.edu/cbowen/cse476x/hatter-delete.php";
    private static final String DELETE_URL = "http://webdev.cse.msu.edu/~ettemaet/cse476/step6/hatter-delete.php";
    //private static final String LOAD_URL = "https://facweb.cse.msu.edu/cbowen/cse476x/hatter-load.php";
    private static final String LOAD_URL = "http://webdev.cse.msu.edu/~ettemaet/cse476/step6/hatter-load.php";
    ...
    public static class CatalogAdapter extends BaseAdapter {
        ...
        public String getId(int position) {
            Item item = newItems.get(position);
            return item.getId();
        }
