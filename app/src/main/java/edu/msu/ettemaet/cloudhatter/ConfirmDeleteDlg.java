...
public class ConfirmDeleteDlg extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        TextView myHatter = (TextView)view.findViewById(R.id.myHatting);
                ...
                public void run() {
                    ...
                    hatterView.post(new Runnable() {
                        ...
                        public void run() {
                            dlg.dismiss();
                            if(fail1) {
                                Toast.makeText(hatterView.getContext(), R.string.delete_fail, Toast.LENGTH_LONG).show();
                            } else {
                                // Success!
